...
at the G1 29DOF checkpoint shipped under ``policy/g1_29dof_locomotion/`` in this package.
...
def generate_launch_description():
    ...
    policy_path = os.path.join(share, 'policy', 'g1_29dof_locomotion', 'policy.pt')
